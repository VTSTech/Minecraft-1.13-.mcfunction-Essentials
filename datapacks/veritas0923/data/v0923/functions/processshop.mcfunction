...
execute as @a[scores={buycheck=1}] run scoreboard players operation @s money -= @s two
execute as @a[scores={buycheck=1}] run give @s minecraft:bread 1
...
execute as @a[scores={buycheck=1}] run scoreboard players operation @s money -= @s eight
execute as @a[scores={buycheck=1}] run give @s minecraft:torch 2
...
execute as @a[scores={buycheck=1}] run scoreboard players operation @s money -= @s four
execute as @a[scores={buycheck=1}] run give @s minecraft:coal 1
...
execute as @a[scores={buycheck=1}] run scoreboard players operation @s money -= @s thirty
execute as @a[scores={buycheck=1}] run give @s minecraft:iron_ingot 1
...
execute as @a[scores={buycheck=1}] run scoreboard players operation @s money -= @s sixty
execute as @a[scores={buycheck=1}] run give @s minecraft:gold_ingot 1